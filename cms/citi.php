...
<head>
<title>iDala Citi dokumenti</title>
...
<div class="row">
  <div class="leftcolumn">
    ...
    <div class="cardDifferent">
      <h2 align="center">iDala ievietotie citi dokumenti</h2>
	</div>
      <div align="center" class="cardDifferent">
                ...
                <h5><font color="blue"><?php echo $msg ;?></font></h5>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                      ...
                      <?php
                      $query=$conn->query("select * from citi order by id desc");
                      while($row=$query->fetch()){
                          ...
                          <tr>
                              ...
                              <td>
                                  <button class="alert-success"><a href="citi.php?del=<?php echo $id;?>">Dzēst</a></button>
                              </td>

                              <td>
                                  <button class="alert-success"><a href="citi.php?file_id=<?php echo $id;?>">Lejupielādēt</a></button>
                              </td>
